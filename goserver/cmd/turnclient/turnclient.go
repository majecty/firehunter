...
func main() {
	host := flag.String("host", "turn.i.juhyung.dev", "TURN Server name.")
	// publicIP := "3.34.13.104"
	// host := flag.String("host", "3.34.13.104", "TURN Server name.")
	port := flag.Int("port", 3478, "Listening port.")
	user := flag.String("user", "juhyung=juhyung", "A pair of username and password (e.g. \"user=pass\")")
